...
namespace OneDriveFinal.Models
{
    public class FilesService
    {
        ...
        public async Task<List<ResultsItem>> UploadLargeFile(GraphServiceClient graphClient)
        {
            ...
            using (Stream fileStream = System.IO.File.OpenRead(HostingEnvironment.MapPath("/Content/Site.css")))
            {
                ...
                UploadSession uploadSession = await graphClient.Me.Drive.Root.ItemWithPath("/Documents/Site.css").CreateUploadSession().Request().PostAsync();
