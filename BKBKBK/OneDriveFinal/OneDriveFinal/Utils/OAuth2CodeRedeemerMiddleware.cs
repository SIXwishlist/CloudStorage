...
namespace OneDriveFinal.Utils
{
    public sealed class OAuth2CodeRedeemerMiddleware : OwinMiddleware
    {
        ...
        public async override Task Invoke(IOwinContext context)
        {
            ...
            //    TokenCache theCache = new EFTokenCache(signedInUserID, hcb).GetMsalCacheInstance();
            ...
            //        //context.Response.Headers.Set("Location", "/Error?message=" + "Authentication SUCCESSFULLY"); 
            //    }
            //    else
            //    {
            //        context.Response.StatusCode = 302;
